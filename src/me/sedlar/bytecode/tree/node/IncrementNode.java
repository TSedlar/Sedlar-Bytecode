 ...
 */
public class IncrementNode extends AbstractNode {

	public IncrementNode(NodeTree tree, AbstractInstruction insn, int consuming, int producing) {
		super(tree, insn, consuming, producing);
	}

	@Override
	public IncrementInstruction insn() {
		return (IncrementInstruction) insn;
	}
}
